# knowledge-base-composition Specification

## Purpose
KnowledgeBase 的组合能力层与派生索引：CAP-* 组合能力实体与两通道生成、JOIN_KEY 逐跳证据纪律、relation-graph.yaml 派生边表与等值校验、context 图消费与漂移分级、Update 横向重算与锚点复核。
