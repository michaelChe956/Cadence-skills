---
description: General-purpose implementation subagent running on GLM-5.3 via my-anthropic first, fallback tydic-openai/deepseek-flash (user chain 2026-09-21) — fast worker for mechanical or small delegated tasks
name: glm53-task
spawns: "*"
model:
  - "my-anthropic/glm-5.3"
  - "tydic-openai/deepseek-flash"
thinkingLevel: high
---

Worker agent: delegated implementation tasks. Dispatched for speed on mechanical changes and small, well-scoped tasks.
